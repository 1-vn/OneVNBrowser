...
import com.onevn.browser.adblock.repository.original.AdBlock
...
class AdBlockActivity : ThemeActivity(), AdBlockMainFragment.OnAdBlockMainListener, AdBlockFragment.AdBlockFragmentListener, AdBlockImportFragment.OnImportListener {
    ...
    companion object {
        const val ACTION_OPEN_BLACK = "com.onevn.browser.adblock.AdBlockActivity.action.open.black"
        const val ACTION_OPEN_WHITE = "com.onevn.browser.adblock.AdBlockActivity.action.open.white"
        const val ACTION_OPEN_WHITE_PAGE = "com.onevn.browser.adblock.AdBlockActivity.action.open.whitepage"
