...
package com.onevn.browser.adblock.service
...
import com.onevn.browser.adblock.filter.abp.*
import com.onevn.browser.adblock.filter.unified.UnifiedFilter
import com.onevn.browser.adblock.filter.unified.element.ElementFilter
import com.onevn.browser.adblock.filter.unified.getFilterDir
import com.onevn.browser.adblock.filter.unified.io.ElementWriter
import com.onevn.browser.adblock.filter.unified.io.FilterWriter
import com.onevn.browser.adblock.repository.AdBlockPref
...
class AbpUpdateService : DaggerIntentService("AbpUpdateService") {
    ...
    companion object {
        private const val ACTION_UPDATE_ALL = "com.onevn.browser.adblock.service.action.UpdateAll"
        private const val ACTION_UPDATE_ABP = "com.onevn.browser.adblock.service.action.UpdateAbp"

        private const val EXTRA_ABP_ENTRY = "com.onevn.browser.adblock.service.extra.entry"
        private const val EXTRA_RESULT = "com.onevn.browser.adblock.service.extra.result"
        private const val EXTRA_FORCE_UPDATE = "com.onevn.browser.adblock.service.extra.update.force"
