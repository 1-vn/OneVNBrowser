...
import com.onevn.browser.core.utility.extensions.ContextExtensionsKt;
import com.onevn.browser.core.utility.log.ErrorReport;
import com.onevn.browser.core.utility.log.Logger;
import com.onevn.browser.download.compatible.DownloadInfoDatabase;
import com.onevn.browser.download.service.DownloadDatabase;
...
import com.onevn.browser.legacy.action.item.CustomMenuSingleAction;
import com.onevn.browser.legacy.action.item.FinishSingleAction;
import com.onevn.browser.legacy.action.manager.HardButtonActionManager;
import com.onevn.browser.legacy.action.manager.LongPressActionManager;
...
import com.onevn.browser.legacy.settings.container.BooleanContainer;
import com.onevn.browser.legacy.settings.container.Containable;
import com.onevn.browser.legacy.settings.container.FloatContainer;
import com.onevn.browser.legacy.settings.container.IntContainer;
import com.onevn.browser.legacy.settings.container.LongContainer;
import com.onevn.browser.legacy.settings.container.StringContainer;
import com.onevn.browser.legacy.settings.container.ToolbarContainer;
import com.onevn.browser.legacy.settings.container.custom.FontSizeContainer;
import com.onevn.browser.legacy.toolbar.ToolbarManager;
import com.onevn.browser.legacy.useragent.UserAgentList;
import com.onevn.browser.legacy.useragent.UserAgentUpdaterKt;
import com.onevn.browser.legacy.utils.converter.PatternUrlConverter;
import com.onevn.browser.legacy.webencode.WebTextEncode;
import com.onevn.browser.legacy.webencode.WebTextEncodeList;
        ...
        if (lastLaunch < versionCode) {
            if (lastLaunch >= 0) {
                ...
                if (lastLaunch < 300303 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    manager.deleteNotificationChannel("com.onevn.browser.channel.dl.notify");
                }
