...
public class BrowserManager {
    public static final String EXTRA_OPENABLE = "com.onevn.browser.BrowserActivity.extra.EXTRA_OPENABLE";
    public static final String EXTRA_LOAD_URL_TAB = "com.onevn.browser.BrowserActivity.extra.EXTRA_LOAD_URL_TAB";
