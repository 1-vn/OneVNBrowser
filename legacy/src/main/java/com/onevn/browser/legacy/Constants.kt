...
package com.onevn.browser.legacy
...
class Constants {
    object activity {
        const val MAIN_BROWSER = "com.onevn.browser.browser.BrowserActivity"
    }
    ...
    object intent {
        ...
        const val EXTRA_OPEN_FROM_YUZU = "$INTENT_EXTRA_PREFIX.open.from.onevn"
