...
package com.onevn.browser.legacy.speeddial.view
...
import com.onevn.browser.core.utility.extensions.getBitmap
import com.onevn.browser.legacy.R
import com.onevn.browser.legacy.history.BrowserHistoryActivity
import com.onevn.browser.legacy.speeddial.SpeedDial
import com.onevn.browser.legacy.speeddial.WebIcon
import com.onevn.browser.legacy.utils.appinfo.AppInfo
import com.onevn.browser.legacy.utils.appinfo.ApplicationListFragment
import com.onevn.browser.legacy.utils.appinfo.ShortCutListFragment
import com.onevn.browser.legacy.utils.stack.SingleStack
...
class SpeedDialSettingActivity : ThemeActivity(), SpeedDialEditCallBack, androidx.fragment.app.FragmentManager.OnBackStackChangedListener, SpeedDialSettingActivityFragment.OnSpeedDialAddListener, SpeedDialSettingActivityEditFragment.GoBackController, ApplicationListFragment.OnAppSelectListener, ShortCutListFragment.OnShortCutSelectListener {
    ...
    companion object {
        const val ACTION_ADD_SPEED_DIAL = "com.onevn.browser.legacy.speeddial.view.SpeedDialSettingActivity.add_speed_dial"
