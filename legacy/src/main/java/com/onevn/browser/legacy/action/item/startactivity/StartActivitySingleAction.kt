...
package com.onevn.browser.legacy.action.item.startactivity
...
import com.onevn.browser.legacy.utils.graphics.LauncherIconDrawable
import com.onevn.browser.ui.app.StartActivityInfo
...
class StartActivitySingleAction : SingleAction, Parcelable {
    ...
    companion object {
        ...
        const val REPLACE_URI = "http://com.onevn.browser/REPLACE_URI"
        const val REPLACE_TITLE = "http://com.onevn.browser/REPLACE_TITLE"
