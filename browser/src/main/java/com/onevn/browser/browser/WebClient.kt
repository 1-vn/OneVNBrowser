...
import com.onevn.browser.adblock.AdBlockController
import com.onevn.browser.adblock.convertToAdBlockContentType
import com.onevn.browser.adblock.filter.mining.MiningProtector
import com.onevn.browser.adblock.isThirdParty
import com.onevn.browser.adblock.repository.abp.AbpDatabase
import com.onevn.browser.adblock.ui.abp.AbpFilterSubscribeDialog
import com.onevn.browser.adblock.ui.original.AdBlockActivity
import com.onevn.browser.bookmark.view.BookmarkActivity
...
import com.onevn.browser.core.utility.extensions.readAssetsText
import com.onevn.browser.core.utility.log.Logger
import com.onevn.browser.core.utility.utils.HttpUtils
import com.onevn.browser.download.core.data.DownloadFile
import com.onevn.browser.download.core.data.DownloadRequest
import com.onevn.browser.download.download
import com.onevn.browser.download.getBlobDownloadJavaScript
import com.onevn.browser.download.getDownloadFolderUri
import com.onevn.browser.download.ui.DownloadListActivity
import com.onevn.browser.download.ui.FastDownloadActivity
import com.onevn.browser.download.ui.fragment.DownloadDialog
import com.onevn.browser.favicon.FaviconAsyncManager
import com.onevn.browser.legacy.Constants
import com.onevn.browser.legacy.R
import com.onevn.browser.legacy.browser.*
import com.onevn.browser.legacy.debug.DebugActivity
import com.onevn.browser.legacy.help.getHelpResponse
import com.onevn.browser.legacy.help.isHelpUrl
import com.onevn.browser.legacy.history.BrowserHistoryActivity
import com.onevn.browser.legacy.history.BrowserHistoryAsyncManager
import com.onevn.browser.legacy.pattern.action.OpenOthersPatternAction
import com.onevn.browser.legacy.pattern.action.WebSettingPatternAction
import com.onevn.browser.legacy.pattern.action.WebSettingResetAction
import com.onevn.browser.legacy.pattern.url.PatternUrlManager
import com.onevn.browser.legacy.readitlater.ReadItLaterActivity
import com.onevn.browser.legacy.resblock.ResourceBlockListActivity
import com.onevn.browser.legacy.resblock.ResourceBlockManager
import com.onevn.browser.legacy.resblock.ResourceChecker
import com.onevn.browser.legacy.settings.PreferenceConstants
...
import com.onevn.browser.legacy.speeddial.SpeedDialAsyncManager
import com.onevn.browser.legacy.speeddial.SpeedDialHtml
import com.onevn.browser.legacy.tab.manager.MainTabData
import com.onevn.browser.legacy.toolbar.sub.GeolocationPermissionToolbar
import com.onevn.browser.legacy.userjs.UserScript
import com.onevn.browser.legacy.userjs.UserScriptDatabase
import com.onevn.browser.legacy.utils.DisplayUtils
import com.onevn.browser.legacy.utils.WebDownloadUtils
...
import com.onevn.browser.legacy.webkit.WebUploadHandler
import com.onevn.browser.legacy.webkit.WebViewRenderingManager
import com.onevn.browser.legacy.webrtc.WebRtcPermission
import com.onevn.browser.ui.BrowserApplication
import com.onevn.browser.ui.dialog.JsAlertDialog
import com.onevn.browser.ui.theme.ThemeData
import com.onevn.browser.webview.CustomWebChromeClient
import com.onevn.browser.webview.CustomWebView
import com.onevn.browser.webview.CustomWebViewClient
import com.onevn.browser.webview.utility.WebViewUtility
import com.onevn.browser.webview.utility.evaluateJavascript
import com.onevn.browser.webview.utility.getUserAgent
