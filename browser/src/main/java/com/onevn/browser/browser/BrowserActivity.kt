...
package com.onevn.browser.browser
...
import com.onevn.browser.adblock.BROADCAST_ACTION_UPDATE_AD_BLOCK_DATA
import com.onevn.browser.adblock.filter.abp.checkNeedUpdate
import com.onevn.browser.adblock.repository.abp.AbpDatabase
import com.onevn.browser.adblock.service.AbpUpdateService
import com.onevn.browser.adblock.ui.original.AddAdBlockDialog
import com.onevn.browser.bookmark.view.showAddBookmarkDialog
import com.onevn.browser.browser.behavior.BottomBarBehavior
import com.onevn.browser.browser.behavior.WebViewBehavior
import com.onevn.browser.browser.connecter.openable.BrowserOpenable
import com.onevn.browser.browser.connecter.openable.forEach
import com.onevn.browser.browser.manager.UserActionManager
import com.onevn.browser.browser.tab.TabManagerFactory
import com.onevn.browser.browser.view.Toolbar
import com.onevn.browser.core.utility.extensions.appCacheFilePath
import com.onevn.browser.core.utility.extensions.getFakeChromeUserAgent
import com.onevn.browser.core.utility.log.ErrorReport
import com.onevn.browser.core.utility.log.Logger
import com.onevn.browser.core.utility.utils.ui
import com.onevn.browser.download.core.data.DownloadFile
import com.onevn.browser.download.ui.FastDownloadActivity
import com.onevn.browser.download.ui.fragment.SaveWebArchiveDialog
...
import com.onevn.browser.legacy.action.item.AutoPageScrollAction
import com.onevn.browser.legacy.action.item.OpenOptionsMenuAction
import com.onevn.browser.legacy.action.item.TabListSingleAction
import com.onevn.browser.legacy.action.manager.ActionIconManager
import com.onevn.browser.legacy.action.manager.MenuActionManager
import com.onevn.browser.legacy.action.view.ActionActivity
import com.onevn.browser.legacy.browser.*
import com.onevn.browser.legacy.gesture.GestureManager
import com.onevn.browser.legacy.history.BrowserHistoryManager
import com.onevn.browser.legacy.menuwindow.MenuWindow
import com.onevn.browser.legacy.readitlater.readItLater
import com.onevn.browser.legacy.search.SearchActivity
import com.onevn.browser.legacy.settings.data.AppData
import com.onevn.browser.legacy.tab.BrowserTabManager
import com.onevn.browser.legacy.tab.TabListLayout
import com.onevn.browser.legacy.tab.UiTabManager
import com.onevn.browser.legacy.tab.manager.MainTabData
import com.onevn.browser.legacy.tab.manager.OnWebViewCreatedListener
import com.onevn.browser.legacy.tab.manager.TabManager
import com.onevn.browser.legacy.tab.manager.WebViewProvider
import com.onevn.browser.legacy.toolbar.ToolbarManager
import com.onevn.browser.legacy.toolbar.sub.WebViewFindDialog
import com.onevn.browser.legacy.toolbar.sub.WebViewFindDialogFactory
import com.onevn.browser.legacy.toolbar.sub.WebViewPageFastScroller
import com.onevn.browser.legacy.utils.CrashlyticsUtils
import com.onevn.browser.legacy.utils.DisplayUtils
import com.onevn.browser.legacy.utils.WebUtils
import com.onevn.browser.legacy.utils.extensions.saveArchive
import com.onevn.browser.legacy.utils.network.ConnectionStateMonitor
import com.onevn.browser.legacy.webkit.TabType
import com.onevn.browser.legacy.webkit.WebCustomViewHandler
import com.onevn.browser.legacy.webkit.WebViewAutoScrollManager
import com.onevn.browser.legacy.webkit.WebViewProxy
import com.onevn.browser.legacy.webrtc.WebRtcPermissionHandler
import com.onevn.browser.legacy.webrtc.core.WebRtcRequest
import com.onevn.browser.ui.BROADCAST_ACTION_NOTIFY_CHANGE_WEB_STATE
import com.onevn.browser.ui.BrowserApplication
import com.onevn.browser.ui.BrowserState
import com.onevn.browser.ui.extensions.createIntentFilter
import com.onevn.browser.ui.theme.ThemeData
import com.onevn.browser.ui.widget.PointerView
import com.onevn.browser.webview.CustomWebHistoryItem
import com.onevn.browser.webview.CustomWebView
import com.onevn.browser.webview.WebViewFactory
import com.onevn.browser.webview.WebViewType
import com.onevn.browser.webview.listener.OnScrollChangedListener
import com.onevn.browser.webview.listener.OnScrollableChangeListener
