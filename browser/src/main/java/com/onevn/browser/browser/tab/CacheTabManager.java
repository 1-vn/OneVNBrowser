...
import com.onevn.browser.core.utility.utils.ArrayUtils;
...
import com.onevn.browser.legacy.tab.manager.TabCache;
import com.onevn.browser.legacy.tab.manager.TabFaviconManager;
import com.onevn.browser.legacy.tab.manager.TabIndexData;
import com.onevn.browser.legacy.tab.manager.TabManager;
import com.onevn.browser.legacy.tab.manager.TabStorage;
import com.onevn.browser.legacy.tab.manager.ThumbnailManager;
...
public class CacheTabManager implements TabManager, TabCache.OnCacheOverFlowListener<MainTabData> {
    ...
    private void setIcon(View view, TabIndexData indexData) {
        if (indexData.getOriginalUrl() == null || indexData.getOriginalUrl().startsWith("onevn:")) {
            return;
        }
